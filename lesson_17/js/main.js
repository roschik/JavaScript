...
var scene, camera, fieldOfView, aspectRatio, nearPlane, farPlane, HEIGHT, WIDTH, renderer, container2;
...
function createScene() {
	...
	// Add the Renderer to the DOM, in the world2 div.
	container2 = document.getElementById('world2');
