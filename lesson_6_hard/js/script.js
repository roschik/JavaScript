...
openBtn.addEventListener('click', () => {
	...
	discountHolder = confirm('У вас есть дисконтная карта нашего магазина? (Скидка 10% предоставляется при наличии дисконтной карты, либо если ваш ежедневный бюджет превышает 10 тыс. руб.)');
	if (discountHolder) {
...
budgetBtn.addEventListener('click', () => {
	...
	if (countBudgetValue.value > 10000) {
		mainList.discount = true;
		discountValue.style.backgroundColor = 'green';
	} else {
		mainList.discount = false;
